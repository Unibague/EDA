...
<section style="width:75%; padding: 5% 10%">
    <h2 style="text-align: center"> Recordatorio diligenciamiento de compromiso - Evaluación de Desempeño </h2>
    <div style="background: #ffffff; padding: 5% 5%">
        <p> Apreciado(a) <strong>{{$data['user_name']}}</strong></p>

        <p> Mediante este correo se le informa atentamente que usted aún no ha realizado el diligenciamiento de su compromiso <strong>{{$data['training_name']}}</strong> </p>
